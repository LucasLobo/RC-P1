                ...
                if msg_split[0] == "AUT" and len(msg_split) == 3:
                    ...
                    if not path.exists(user_file):
                        ...
                        if stored_pass == password:
                            ...
                            reply = "AUR NOK\n"
                elif msg_split[0] == "LSD" and len(msg_split) == 1 and user != "":
                    ...
                    if len_dirs != 0:
                        ...
                        reply = "LDR 0\n"
                elif msg_split[0] == "DLU" and len(msg_split) == 1 and user != "":
